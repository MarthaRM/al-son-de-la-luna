...
function scene:create( event )
    ...
    bg = display.newImage("images/tuto.png")-- mostrar la imagen en pantalla
    ...
    text = display.newText("Toca cualquier lugar para comenzar", display.contentCenterX , screenHeight-30, native.systemFontBold, 24) 
